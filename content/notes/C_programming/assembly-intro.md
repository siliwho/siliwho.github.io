# Intro To Assembly and GDB

I wrote this c code in Assembly as you can see below
...
> Error: I wrote a wrong code in the line where i am decrimenting the x2 register for the loop i did `addi x2,x0,-1` which is wrong, it sets x2 to -1 or in this case overflow occors and its sets to _0xffffffff_ so i changed it to correct code `addi x2,x2,-1`.
